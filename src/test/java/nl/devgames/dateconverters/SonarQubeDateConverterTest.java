...
public class SonarQubeDateConverterTest {

    @Test
    public void testSonarDateStringIsParsedCorrectly() throws Exception{
        DateConverter dateConverter = new SonarQubeDateConverter();
        String date = "2016-06-11T12:00:30+0200";
    ...
    public void testFormattedDateStringMatchesExpectedOutcome() {
        DateConverter dateConverter = new SonarQubeDateConverter();
        String expectedOutcome = "2016-06-11T12:00:30+0200";
